...
class Pokemon
	...
	def initialize(level=1, name=self.class)
		@level = level
		@name = name
	...
	def self.moves(*arr)
		arr.each do |movetext|
			add_move($moves[movetext.downcase.gsub(/[^a-z]/,'')])
		end
		@moves
	end
	...
	traits :basehp, :baseattack, :basedefense, :basespattack, :basespdefense, :basespeed, :type 
